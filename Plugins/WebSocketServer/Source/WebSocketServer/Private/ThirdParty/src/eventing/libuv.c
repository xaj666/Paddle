...
static void prepare_cb(uv_prepare_t *p) {
    struct us_loop_t *loop = (struct us_loop_t*)p->data;
...
static void timer_cb(uv_timer_t *t) {
    struct us_internal_callback_t *cb = (struct us_internal_callback_t*)t->data;
    cb->cb(cb);
}

static void async_cb(uv_async_t *a) {
    struct us_internal_callback_t *cb = (struct us_internal_callback_t*)a->data;
...
struct us_loop_t *us_create_loop(void *hint, void (*wakeup_cb)(struct us_loop_t *loop), void (*pre_cb)(struct us_loop_t *loop), void (*post_cb)(struct us_loop_t *loop), unsigned int ext_size) {
    ...
    loop->uv_loop = (uv_loop_t*)(hint ? hint : uv_loop_new());
    loop->is_default = hint != 0;

    loop->uv_pre = (uv_prepare_t*)malloc(sizeof(uv_prepare_t));
    ...
    loop->uv_check = (uv_check_t*)malloc(sizeof(uv_check_t));
...
struct us_poll_t *us_create_poll(struct us_loop_t *loop, int fallthrough, unsigned int ext_size) {
    ...
    p->uv_p = (struct uv_poll_t*)malloc(sizeof(uv_poll_t));
    p->uv_p->data = p;
    return p;
}
...
struct us_timer_t *us_create_timer(struct us_loop_t *loop, int fallthrough, unsigned int ext_size) {
    struct us_internal_callback_t *cb = (struct us_internal_callback_t*)
        malloc(sizeof(struct us_internal_callback_t) + sizeof(uv_timer_t) + ext_size);
...
struct us_internal_async *us_internal_create_async(struct us_loop_t *loop, int fallthrough, unsigned int ext_size) {
    struct us_internal_callback_t *cb = (struct us_internal_callback_t*)malloc(sizeof(struct us_internal_callback_t) + sizeof(uv_async_t) + ext_size);
